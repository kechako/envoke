...
func (vq *VariableQuery) IDs(ctx context.Context) (ids []int, err error) {
...
//		GroupBy(variable.FieldEnvironmentID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Variable.Query().
//		Select(variable.FieldEnvironmentID).
//		Scan(ctx, &v)
...
func (vq *VariableQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(variable.Table, variable.Columns, sqlgraph.NewFieldSpec(variable.FieldID, field.TypeInt))
	_spec.From = vq.sql
